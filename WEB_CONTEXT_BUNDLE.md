...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "wikipedia:wikipedia-ea86bd0c60db5d84"
    ],
    "allowed_axioms": [
    ...
    "problem_id": "problem:wikipedia-ea86bd0c60db5d84",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-ea86bd0c60db5d84",
        "url": "https://en.wikipedia.org/wiki/Algebraically_closed_field"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Is every infinite, minimal field of characteristic zero algebraically closed ? (Here, \"minimal\" means that every definable subset of the structure is finite or co-finite.)",
      "version": 1
    },
    "title": "Is every infinite, minimal field of characteristic zero algebraically closed ?",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "61c38b211cd873d21dfd89e0bf0fe30b77096ee5807b1bbc9cc293d290b85d06"
}
```
